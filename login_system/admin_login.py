...
tk.Label(root, text="Admin Login", font=("Arial", 14, "bold"), bg="lightblue").pack()
...
btn_login = tk.Button(btn_frame, text="Login", font=("Arial", 12), bg="red", fg="black", command=admin_login)
